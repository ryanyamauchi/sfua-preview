...
values
  ('Seeds of Hope (Episcopal Diocese of LA)',
   ...
   'Network-wide: ~5 million lbs/year across ~92 urban farms, ~75 pantries, ~70 meal programs (per diocesela.org)',
   false, null, null, null, null,
   'Food pantries and feeding programs across the six-county diocese',
   'Pre-filled from seedsofhopela.org and diocesela.org (Jun 2026) — Seeds of Hope to verify and add individual sites.',
   false),
  ...
  ('Food Access LA',
   ...
   'Pre-filled from foodaccessla.org (Jun 2026) — Food Access LA to verify. Org also runs LA River, Central Ave, and Compton College markets (add addresses).',
   false),
